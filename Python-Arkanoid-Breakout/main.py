...
# Load sound effects
collision_sound = pygame.mixer.Sound("mixkit-arcade-retro-jump-223.wav")
score_sound = pygame.mixer.Sound("mixkit-arcade-mechanical-bling-210.wav")
...
def show_menu():
    ...
    menu_text = menu_font.render("Press SPACE to start", True, pygame.Color('white'))
...
while True:
    ...
    if len(block_list) > 0:
        ...
        if hit_index != -1:
            ...
            score += 10  # Increase score when a block is hit
    ...
    high_score_text = font.render("High Score: " + str(high_score), True, pygame.Color('white'))
    sc.blit(score_text, (10, 10))
    sc.blit(high_score_text, (10, 50))
